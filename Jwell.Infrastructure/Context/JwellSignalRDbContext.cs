...
{
    public class JwellSignalRDbContext : DbContext
    {       
        public DbSet<PropellingMovementInterface> PropellingMovementInterface { get; set; }    

        public DbSet<PropellingMovementManager> PropellingMovementManager { get; set; }

        public JwellSignalRDbContext()
            : base("JwellSignalR")
        {

        }

        public JwellSignalRDbContext(string nameOrConnectionString)
            : base(nameOrConnectionString)
        {

        }

        protected JwellSignalRDbContext(DbCompiledModel model) : base(model)
        {
        }      
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.HasDefaultSchema("JWELL_PROPELLINGMOVEMENT");
